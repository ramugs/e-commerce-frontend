...
import ForgetPasswordModal from "../../components/admin/forgetPasswordModal";
...
const LoginPage = () => {
  ...
  const handleForgetPassmodalClose = () => setForgetPassModal(false);
  const handleForgetPassModalShow = () => setForgetPassModal(true);
  ...
  return (
    <>
      <ForgetPasswordModal
        ...
        handleForgetPassmodalClose={handleForgetPassmodalClose}
      />
      <div className="w-100 vh_100 position-relative">
        ...
        >
          <form onSubmit={formik.handleSubmit}>
            ...
            <div
              className={`mt-5 border_radius_20 shadow ${
            ...
            <div
              className={` border_radius_20 shadow ${
            ...
            <div className="text-end">
              <span
                className="darkBlue_color cursor_pointer"
                onClick={() => handleForgetPassModalShow()}
              >
                Forget Password?
              </span>
            </div>
            ...
            <div className="mt-3 ">
              <button
                className="border_none w-100 p-2 blue_bg border_radius_20 shadow"
                type="submit"
              >
